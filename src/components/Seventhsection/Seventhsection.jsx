  ...
  return (
    ...
    <div className="  flex flex-col justify-center lg:px-[70px] lg:flex-row lg:justify-between lg;items-center px-5 py-24 lg:pt-16 font-plus ">
      <div className=" flex flex-col items-center lg:flex-row justify-between">
        <div>
            <div className='w-[81px] h-[51px] flex justify-between items-center mb-[20px] bg-[#F5F6F7]'><div className='bg-[#FFDA31] w-[5px] h-[51px] flex justify-start'></div><div className='flex justify-end items-center '><h4 className='font-plus font-semibold pr-[20px] text-[16px] text-[#1A1C1F] flex justify-center'>FAQ</h4></div></div>
          ...
          <div className='flex flex-col lg:flex lg:flex-row lg:justify-between items-center '>
            <div className='lg:w-[400px]'><img src={seventhiconpic} alt="" className='xl:w-[400px]'/></div>
